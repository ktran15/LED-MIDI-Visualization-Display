...
def ledColorHelper(pitch, colorIndex):
    if pitch < 60:
        interValueColor = colorIndex[0] # if pitch is in lower half of range, use first color in data list
    else:
        interValueColor = colorIndex[1] # if pitch is in upper half of range, use second color in data list
