...
def ledColor(pitch, velocity):
    R = (ledColorHelper(pitch, [14,15])) * (veloToBrightness(velocity) / 255) # provides data list of RED in ROYGBIV
    G = (ledColorHelper(pitch, [48,94])) * (veloToBrightness(velocity) / 255) # provides data list of GREEN in ROYGBIV
    B = (ledColorHelper(pitch, [75,117])) * (veloToBrightness(velocity) / 255) # provides data list of BLUE in ROYGBIV
